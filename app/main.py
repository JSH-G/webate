...
from .routers import category, create_menu, rating, favorite_hotel, get_hotel, offer_scan, contact_us, get_admin_side, hotel_image
...
app.include_router(hotel_image.router)